                        ...
                        <div class="row">
                            <div class="col col-12 col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <br>
                                    @if ($posts->featured_image && file_exists(public_path('storage/images/posts/') . $posts->featured_image))
